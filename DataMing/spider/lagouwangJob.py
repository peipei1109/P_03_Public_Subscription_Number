...
#http://mp.weixin.qq.com/s?__biz=MzA3MDg0MjgxNQ==&mid=2652389872&idx=1&sn=a14238e02ca0d3253e0e28f6893ac0c4&scene=0#rd
...
def get_page(url, pn, keyword):
    ...
    page = urllib2.urlopen(req, data=data.encode('utf-8')).read()
